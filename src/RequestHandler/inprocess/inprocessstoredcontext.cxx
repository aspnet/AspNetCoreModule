...
)
{
    ...
    // TODO how do get the module id?
    *ppInProcessStoredContext = (IN_PROCESS_STORED_CONTEXT*)pHttpContext->GetModuleContextContainer()->GetModuleContext((HTTP_MODULE_ID) 100);
    if (*ppInProcessStoredContext == NULL)
    {
        return E_FAIL;
    }
